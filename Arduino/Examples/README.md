...
<br>
ВНИМАНИЕ внимательно смотим соответствие версии платы и софта!<br>
При переходе с версии 1.3 на 1.4 были большие изменения, поэтому примеры надо адаптировать под версию платы.<br>
